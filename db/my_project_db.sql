...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 21, 2019 at 06:42 AM
...
CREATE TABLE `cms_article_upload` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `cms_car_pricelist` (
...
CREATE TABLE `cms_destination_area` (
...
CREATE TABLE `cms_destination_period` (
...
CREATE TABLE `cms_payment_setting` (
  `id` int(11) NOT NULL,
  `type` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `cms_slider_upload` (
  `id` int(11) NOT NULL,
  `slide_id` int(11) NOT NULL,
  `upload_id` int(11) NOT NULL,
  `entered` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
CREATE TABLE `cms_user_activity_2016` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `message` text COLLATE utf8_unicode_ci NOT NULL,
  `entered` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
(386, 'DvEorIJEDogSeb', 0, '::1', '', 'en_US', 'THB', 0, 0, '2018-10-23 05:28:22', '2018-10-23 03:28:22'),
(387, 'A14cS5MPCKgsdMz', 0, '::1', '', 'en_US', 'THB', 0, 0, '2018-10-23 05:29:03', '2018-10-23 03:29:03'),
(388, 'WrhRWydZAFvMJIR', 0, '::1', '', 'en_US', 'THB', 0, 0, '2018-10-23 05:30:04', '2018-10-23 03:30:04'),
(389, 'jeSYIWcJnapJee', 0, '::1', '', 'en_US', 'THB', 0, 0, '2018-10-23 05:30:15', '2018-10-23 03:30:15'),
(390, 'YKDjAj4sY397L3R', 0, '::1', '', 'en_US', 'THB', 0, 0, '2018-10-23 05:30:24', '2018-10-23 03:30:24'),
(391, 'ZYfm5qZr56OEU6J', 0, '::1', '', 'en_US', 'THB', 0, 0, '2018-10-23 05:30:29', '2018-10-23 03:30:29'),
(392, 'o2HnBc52TJoLpn', 0, '::1', '', 'en_US', 'THB', 0, 0, '2018-10-23 05:30:53', '2018-10-23 03:30:53'),
(393, 'NdQzfWfzagv14aO', 0, '::1', '', 'en_US', 'THB', 0, 0, '2018-10-23 05:30:57', '2018-10-23 03:30:57'),
(394, 'cedhoAKsP3IWynE', 0, '::1', '', 'en_US', 'THB', 0, 0, '2018-10-26 07:41:25', '2018-10-26 05:41:25'),
(395, '3aA2TVvKlOAZLXN', 0, '::1', '', 'en_US', 'THB', 0, 0, '2019-08-21 04:37:23', '2019-08-21 02:37:23'),
(396, '0Cu7fRTWRdR4ItW', 0, '::1', '', 'en_US', 'THB', 0, 0, '2019-08-21 04:38:43', '2019-08-21 02:38:43'),
(397, 'fydvH66WoE3Mc7', 0, '::1', '', 'en_US', 'THB', 0, 0, '2019-08-21 04:38:55', '2019-08-21 02:38:55'),
(398, '2MXNyGRRf3uXjqP', 0, '::1', '', 'en_US', 'THB', 0, 0, '2019-08-21 04:39:12', '2019-08-21 02:39:12'),
(399, 'L2mJqg2yILMPy8b', 0, '::1', '', 'en_US', 'THB', 0, 0, '2019-08-21 04:39:22', '2019-08-21 02:39:22'),
(400, 'ohhVjPBx1acbfB', 0, '::1', '', 'en_US', 'THB', 0, 0, '2019-08-21 04:39:39', '2019-08-21 02:39:39'),
(401, '1ZbWrTRK4Cfrlga', 0, '::1', '', 'en_US', 'THB', 0, 0, '2019-08-21 04:40:07', '2019-08-21 02:40:07'),
(402, '1SKdhOgPx7RAbrQ', 0, '::1', '', 'en_US', 'THB', 0, 0, '2019-08-21 04:40:32', '2019-08-21 02:40:32');
...
--
-- Indexes for table `cms_article_comment`
--
ALTER TABLE `cms_article_comment`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cms_article_upload`
--
ALTER TABLE `cms_article_upload`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `cms_car`
--
ALTER TABLE `cms_car`
  ADD PRIMARY KEY (`car_id`);

--
-- Indexes for table `cms_cart`
--
ALTER TABLE `cms_cart`
  ADD PRIMARY KEY (`cart_id`);

--
-- Indexes for table `cms_car_pricelist`
--
ALTER TABLE `cms_car_pricelist`
  ADD PRIMARY KEY (`price_id`);

--
-- Indexes for table `cms_car_service`
--
ALTER TABLE `cms_car_service`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `cms_currency`
--
ALTER TABLE `cms_currency`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cms_destination`
--
ALTER TABLE `cms_destination`
  ADD PRIMARY KEY (`destination_id`);

--
-- Indexes for table `cms_destination_area`
--
ALTER TABLE `cms_destination_area`
  ADD PRIMARY KEY (`area_id`);

--
-- Indexes for table `cms_destination_period`
--
ALTER TABLE `cms_destination_period`
  ADD PRIMARY KEY (`period_id`);

--
-- Indexes for table `cms_featured`
--
ALTER TABLE `cms_featured`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cms_hotel`
--
ALTER TABLE `cms_hotel`
...
--
-- Indexes for table `cms_payment_setting`
--
ALTER TABLE `cms_payment_setting`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cms_property`
--
ALTER TABLE `cms_property`
  ADD PRIMARY KEY (`property_id`);

--
-- Indexes for table `cms_seo`
--
ALTER TABLE `cms_seo`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cms_shipping`
--
ALTER TABLE `cms_shipping`
...
--
-- Indexes for table `cms_slider_lang`
--
ALTER TABLE `cms_slider_lang`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cms_slider_upload`
--
ALTER TABLE `cms_slider_upload`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `cms_tour_rate`
--
ALTER TABLE `cms_tour_rate`
...
--
-- Indexes for table `cms_user_activity_2016`
--
ALTER TABLE `cms_user_activity_2016`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `cms_wishlist`
--
ALTER TABLE `cms_wishlist`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `session_website`
--
ALTER TABLE `session_website`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `cms_api`
--
ALTER TABLE `cms_api`
...
--
-- AUTO_INCREMENT for table `cms_article_comment`
--
ALTER TABLE `cms_article_comment`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `cms_article_upload`
--
ALTER TABLE `cms_article_upload`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `cms_car`
--
ALTER TABLE `cms_car`
  MODIFY `car_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `cms_cart`
--
ALTER TABLE `cms_cart`
  MODIFY `cart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;

--
-- AUTO_INCREMENT for table `cms_car_pricelist`
--
ALTER TABLE `cms_car_pricelist`
  MODIFY `price_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=506;

--
-- AUTO_INCREMENT for table `cms_car_service`
--
ALTER TABLE `cms_car_service`
...
--
-- AUTO_INCREMENT for table `cms_currency`
--
ALTER TABLE `cms_currency`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=181;

--
-- AUTO_INCREMENT for table `cms_destination`
--
ALTER TABLE `cms_destination`
  MODIFY `destination_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `cms_destination_area`
--
ALTER TABLE `cms_destination_area`
  MODIFY `area_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `cms_destination_period`
--
ALTER TABLE `cms_destination_period`
  MODIFY `period_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `cms_featured`
--
ALTER TABLE `cms_featured`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `cms_hotel`
--
ALTER TABLE `cms_hotel`
...
--
-- AUTO_INCREMENT for table `cms_newsletter`
--
ALTER TABLE `cms_newsletter`
  MODIFY `newsletter_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
-- AUTO_INCREMENT for table `cms_payment_setting`
--
ALTER TABLE `cms_payment_setting`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `cms_property`
--
ALTER TABLE `cms_property`
  MODIFY `property_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `cms_seo`
--
ALTER TABLE `cms_seo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `cms_shipping`
--
ALTER TABLE `cms_shipping`
...
--
-- AUTO_INCREMENT for table `cms_slider_lang`
--
ALTER TABLE `cms_slider_lang`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `cms_slider_upload`
--
ALTER TABLE `cms_slider_upload`
...
--
-- AUTO_INCREMENT for table `cms_tour_rate`
--
ALTER TABLE `cms_tour_rate`
...
--
ALTER TABLE `cms_upload`
  MODIFY `upload_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
...
--
-- AUTO_INCREMENT for table `cms_user_activity_2016`
--
ALTER TABLE `cms_user_activity_2016`
...
--
ALTER TABLE `cms_widget`
  MODIFY `widget_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `cms_wishlist`
--
ALTER TABLE `cms_wishlist`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `session_website`
--
ALTER TABLE `session_website`
