					...
					<div class="tbl-row">
						<div class="tbl-cell">
							...
							<ol class="breadcrumb breadcrumb-simple">
								...
								<li class="active"><?php if(empty($category[0]->category_id)){ echo 'Add';}else{ echo 'Edit';}?></li>
							</ol>
						</div>
					</div>
				</div>
...
<?php if($save){ ?>
          <div class="alert alert-success alert-dismissable ">
            ...
            Your category has been update. </div>
          <?php }?>
          <?php if($delete == 1){ ?>
          <div class="alert alert-danger alert-dismissable ">
            <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
            Your category has been delete. </div>
          <?php }?>
          <?php if($delete == 'false'){?>
          <div class="alert alert-danger alert-dismissable ">
            <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
            Your category can't been delete. </div>
          <?php }?>
