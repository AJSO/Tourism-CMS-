        ...
        <div class="tbl-row">
          <div class="tbl-cell">
            ...
            <ol class="breadcrumb breadcrumb-simple">
              ...
              <li class="active">
                <?php if(empty($category[0]->category_id)){ echo 'Add';}else{ echo 'Edit';}?>
              </li>
            </ol>
          </div>
        </div>
									...
									if(count($languages) > 1){
										...
										foreach($languages as $i=>$v){
											...
											if($v->code == $property[0]->lang){
												echo '<a class="btn btn-primary" href="'.base_url().'admin/category/edit?category_id='.$value->category_id.'">';
												echo '<img src="'.base_url().'assets/backend/img/spacer.png" class="flag flag-'.$c2.'" height="32" width="32" />';
												echo '</a>';
											}else{
												echo '<a class="btn btn-primary" href="'.base_url().'admin/category/'.$v->code.'/edit?category_id='.$value->category_id.'">';
												echo '<img src="'.base_url().'assets/backend/img/spacer.png" class="flag flag-'.$c2.'" height="32" width="32" />';
												echo '</a>';
											}
											echo '</li>';
